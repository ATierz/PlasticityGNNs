        ...
        with open(filename, 'r') as file:
            ...
            for line in file:
                ...
                if re.search(self.pattern_line, line):
                    # When a line matches the data pattern, store it in current_data list
                    ...
                    df = pd.DataFrame([data_line.split() for data_line in current_data])
                    df.columns = ['Node_Label', 'U_Magnitude', 'U_U1', 'U_U2']
                    ...
                    reading_data = False       # Reset the flag
                elif line.strip() == '---------------------------------------------------------':
